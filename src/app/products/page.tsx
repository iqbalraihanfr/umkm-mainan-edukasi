...
const Products: React.FC = () => {
    ...
    const mockProducts: Product[] = [
      {
        ...
        description: 'Puzzle edukatif untuk belajar huruf dan melatih motorik halus',
        descriptionEn: 'Educational puzzle for learning letters and training fine motor skills',
        price: 85000,
      ...
      },
      {
        ...
        description: 'Set balok kayu warna-warni untuk mengembangkan kreativitas',
      ...
      },
      {
        ...
        description: 'Rumah boneka kayu dengan furniture lengkap untuk bermain peran',
        descriptionEn: 'Wooden dollhouse with complete furniture for role playing',
        price: 350000,
        images: ['/placeholder.svg'],
      ...
      },
      {
        ...
        descriptionEn: 'Wooden musical instruments set to develop children\'s musical talent',
        price: 180000,
        images: ['/placeholder.svg'],
        category: 'Musik',
        categoryEn: 'Music',
  ...
  useEffect(() => {
    ...
    if (selectedCategory !== 'all') {
      filtered = filtered.filter(product => 
        product.category === selectedCategory || product.categoryEn === selectedCategory
      );
    }
