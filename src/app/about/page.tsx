        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <Card
                key={index}
                className="text-center hover:shadow-lg transition-shadow border-wood-200"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <Card className="text-center border-wood-200">
              <CardContent className="p-6">
                ...
                <p className="text-wood-600 mb-2">
                  {language === "id"
                    ? "Desainer & Quality Control"
                    : "Designer & Quality Control"}
                </p>
                <p className="text-sm text-wood-500">
                  {language === "id"
                    ? "Ahli desain mainan anak"
                    : "Children's toy design expert"}
                </p>
              </CardContent>
            </Card>
