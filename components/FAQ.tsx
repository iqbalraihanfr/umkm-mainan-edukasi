...
const FAQ: React.FC = () => {
  ...
  const faqData = [
    {
      question: language === 'id' ? 'Apakah mainan kayu aman untuk anak-anak?' : 'Are wooden toys safe for children?',
      answer: language === 'id' 
    ...
    {
      question: language === 'id' ? 'Berapa lama waktu pengiriman?' : 'How long is the delivery time?',
      answer: language === 'id'
    ...
    {
      question: language === 'id' ? 'Apakah bisa custom design mainan?' : 'Can you custom design toys?',
      answer: language === 'id'
    ...
    {
      question: language === 'id' ? 'Bagaimana cara merawat mainan kayu?' : 'How to care for wooden toys?',
      answer: language === 'id'
    ...
    {
      question: language === 'id' ? 'Apakah ada garansi untuk produk?' : 'Is there a warranty for products?',
      answer: language === 'id'
    ...
    {
      question: language === 'id' ? 'Apakah tersedia untuk ekspor?' : 'Is it available for export?',
      answer: language === 'id'
